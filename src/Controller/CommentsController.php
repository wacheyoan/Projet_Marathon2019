...
class CommentsController extends AbstractController
{
    ...
    /**
     * @Route("valid/{id}", name="comments_valid", methods={"GET"})
     */
    public function valid(Comments $comments){

        if($comments->getValidated()){

            $comments->setValidated(false);

        }else{

            $comments->setValidated(true);
